...
editSave.on('click', function() {
	...
	if (!flag) {
		...
		var reqData = {
			...
			userAddressCountry: $(".input.userAddressCountry").text()  === "请添加" ? null : $(".input.userAddressCountry").text(),
			userAddressProvince: $(".input.userAddressProvince").text()  === "请添加" ? null : $(".input.userAddressProvince").text(),
			userAddressCity: $(".input.userAddressCity").text()  === "请添加" ? null : $(".input.userAddressCity").text(),
			userAddressStreetaddress: $(".input.userAddressStreetaddress").text()  === "请添加" ? null : $(".input.userAddressStreetaddress").text(),
			userAddressPostalcode: $(".input.userAddressPostalcode").text()  === "请添加" ? null : $(".input.userAddressPostalcode").text(),
