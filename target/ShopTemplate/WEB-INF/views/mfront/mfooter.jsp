...
<div class="chow_fcopy">© <span>Megalook</span> 2019. All Rights Reserved</div>
				...
				for(var key2 in fData) {					
					...
					if(fData[key2].footnavIfIncome) {
						footerData[key].children.push({
						    ...
						    "icon": "",
						    "link": "/ShopTemplate/MlbackFootNav/toMlfrontFootNavPage?block="+ block +"&id=" + fData[key2].footnavId
						})						
					} else {
						footerData[key].children.push({
							"name": fData[key2].footnavName,
