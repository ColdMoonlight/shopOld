	    ...
	    <div class="main-box">
	        ...
	        <div class="content">
	            <div class="table-box">
	                <!-- operator -->
	                <div class="op">
	                    <a href="#" class="btn btn-default" role="button"> <i class="glyphicon glyphicon-tasks"></i> 提现记录列表</a>
	                    <a href="${APP_PATH }/HomePage/toMoneyOutApplyPage" id="task_add_modal_btn" class="btn btn-primary" role="button" >提现申请</a>
	                </div>
	                <!-- table-content -->
...
<script type="text/javascript">
	...
	function to_page(pn){
		$.ajax({
			url:"${APP_PATH}/moneyOut/moneyOutApplySuccessList",
			data:"pn="+pn,
			type:"POST",
	...
	function build_task_table(result){
		...
		$.each(task,function(index,item){
			...
			var moneyoutOperaterTd = $("<td></td>").append(item.moneyoutOperater);
