			...
			<div class="main-box nicescroll">
				...
				<div class="content">
					...
					<div class="model" data-type="pie">
						...
						<div class="model-b model-pie num_data">
							<div class="model-pie-data model-pie-list num_box_list">
								...
								<span class="model-item addcart_box">
									<a href="${APP_PATH }/MlbackAddCartViewDetail/toMlbackAddCartViewDetailPage" title="加购量" class="cart_num addcart"><div class="model-text">加购量</div><div class="model-num">0</div></a>
									<a href="${APP_PATH }/MlbackAddCartViewDetail/toMlbackAddCartViewbuynowDetailPage" title="buynow加购量" class="cart_num addcart2"><div class="model-text">buynow加购量</div><div class="model-num">0</div></a>
								</span>
								<span class="model-item addcart_box">
						...
						<div class="model-b model-pie num_data">
							<div class="model-pie-data model-pie-list num_box_list">
								<a href="${APP_PATH }/MlbackAddPayinfoViewDetail/toMlbackAddPayinfoViewDetailPage" title="成交金额"  class="model-item PayinfoSuccessNum"><div class="model-text">成交num</div><div class="model-num">0</div></a>
								<span class="model-item addcart_box">
									<a href="${APP_PATH }/MlbackAddCartViewDetail/toMlbackAddCartViewDetailPage" title="加购量" class="cart_num addcart"><div class="model-text">加购量</div><div class="model-num">0</div></a>
									<a href="${APP_PATH }/MlbackAddCartViewDetail/toMlbackAddCartViewbuynowDetailPage" title="buynow加购量" class="cart_num addcart2"><div class="model-text">buynow加购量</div><div class="model-num">0</div></a>
								</span>
								...
								<a href="${APP_PATH }/MlbackProductViewDetail/toMlbackProductViewDetailPage" title="结算量" class="model-item accounts"><div class="model-text">结算量</div><div class="model-num">0</div></a>
							</div>
						</div>
					</div>
					<!-- pie -->
