...
<body>
	...
	<div class="main cart-box">
		...
		<div class="cart-footer" style="display: none">
			...
			<div class="op">
				<a href="javascript:;" class="btn btn-default paypal-button paypal-button-paypal">
				...
				<a href="javascript:;" style="width: 50%;" class="btn btn-black calc-price" id="clickCheckoutGooGle">Checkout</a>
			</div>
		</div>
	</div>
	<!--*****热品推荐**********************-->
