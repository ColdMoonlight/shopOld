...
function renderProdcutList(parent, data) {
	...
	for (var i=0, len=data.length; i<len; i+=1) {
        ...
        '<input onclick="event.stopPropagation();" class="checkbox" type="checkbox" data-cartitemid="'+ data[i].cartitemId +'" data-productid="'+ data[i].cartitemProductId +'">' +
        ...
        '<div class="content">' +
         ' <div class="text">' +
           ...
           for(var j=0, len2=skuIdArr.length; j<len2; j+=1) {
        	   html += '<div class="c-item" data-id="'+ skuIdArr[j] +'" data-price="+ skuPriceArr[j] +">'+skuIdNameArr[j]+': '+ skuNameArr[j] +'</div>';
           }
          html+=  '</div>' +
          '</div>' +
          '<div class="num" data-cartitemid="'+  data[i].cartitemId +'" data-cartid="'+  data[i].cartitemCartId +'" data-productname="'+  data[i].cartitemProductName +'">' +
            '<span class="price">$'+ (getPrice(data[i].cartitemProductOriginalprice, skuPriceArr, data[i].cartitemProductActoff).current) +'</span>' +
          	'<span class="original">$'+ (getPrice(data[i].cartitemProductOriginalprice, skuPriceArr, data[i].cartitemProductActoff).origin) +'</span>' +
