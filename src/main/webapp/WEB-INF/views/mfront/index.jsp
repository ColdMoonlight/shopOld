...
$.ajax({
  ...
  success: function(data) {
    if(data.code === 100) {
      ...
      $('.product-banner1.banner').html('<img src="' + category.categoryImgPcurl + '" alt=" + category.categoryName + ">');
    } else {
...
$.ajax({
  ...
  success: function(data) {
    if(data.code === 100) {
      ...
      var category = data.extend.mlbackCategoryOne;
      // categoryName categoryImgurl
      $('.product-banner2.banner').html('<img src="' + category.categoryImgPcurl + '" alt=" + category.categoryName + ">');
    } else {
      renderErrorMsg(prodcutBox, '未获取到产品相关的数据');
    }
  }
...
$.ajax({
  ...
  success: function(data) {
    if(data.code === 100) {
      ...
      var category = data.extend.mlbackCategoryOne;
      // categoryName categoryImgurl
      $('.product-banner3.banner').html('<img src="' + category.categoryImgPcurl + '" alt=" + category.categoryName + ">');
    } else {
      renderErrorMsg(prodcutBox, '未获取到产品相关的数据');
    }
  }
