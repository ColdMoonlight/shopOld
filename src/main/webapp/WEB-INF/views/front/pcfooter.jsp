				...
				<div class="tt-col-left">
					<div class="tt-col-item tt-logo-col">
						...
						<a class="tt-logo tt-logo-alignment" href="index.html">
							<img src="${APP_PATH }/static/pc/images/custom/logo.png" alt="">
						</a>
						<!-- /logo -->
					</div>
					<div class="tt-col-item">
						...
						<div class="tt-box-copyright">
							&copy; Wokiee 2018. All Rights <a href="http://www.17sucai.com/" title="17sucai">Reserved</a>
						</div>
						<!-- /copyright -->
					</div>
				</div>
...
<script src="${APP_PATH }/static/pc/external/slick/slick.min.js"></script>
<script src="${APP_PATH }/static/pc/external/perfect-scrollbar/perfect-scrollbar.min.js"></script>
<script src="${APP_PATH }/static/pc/external/panelmenu/panelmenu.js"></script>
<script src="${APP_PATH }/static/pc/external/instafeed/instafeed.min.js"></script>
<script src="${APP_PATH }/static/pc/external/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
<script src="${APP_PATH }/static/pc/external/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
<script src="${APP_PATH }/static/pc/external/countdown/jquery.plugin.min.js"></script>
<script src="${APP_PATH }/static/pc/external/countdown/jquery.countdown.min.js"></script>
<script src="${APP_PATH }/static/pc/external/lazyLoad/lazyload.min.js"></script>
<script src="${APP_PATH }/static/pc/js/main.js"></script>
<!-- form validation and sending to mail -->
<script src="${APP_PATH }/static/pc/external/form/jquery.form.js"></script>
<script src="${APP_PATH }/static/pc/external/form/jquery.validate.min.js"></script>
<script src="${APP_PATH }/static/pc/external/form/jquery.form-init.js"></script>
