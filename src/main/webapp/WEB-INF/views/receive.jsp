...
<%
    ...
    /* response.sendRedirect("http://47.92.171.86:8080/udid"); */
    /*response.sendRedirect("http://localhost:8180/ShareNum/HomePage/udid");*/
...
<div id="content">
    ...
    <a class="buttons" href="http://192.168.0.110:8180/ShareNum/UDID/udid.mobileconfig" target="_blank">点击获取您的UDID</a>
