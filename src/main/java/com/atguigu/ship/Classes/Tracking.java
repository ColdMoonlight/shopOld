package com.atguigu.ship.Classes;
...
public class Tracking {
    ...
    /**Identifier of the tracking in the Aftership system	跟踪的标识符*/
    private String id;
    ...
    /**以天为单位的总交付时间，按第一个检查点时间与交付时间的时差计算
     *发货时间，以及未发货的时间和当前时间。值为“0”
     *只有一个检查点的待发货或已发货
     * */
    ...
    /**ISO Alpha-3（三个字母）指定装运目的地。
	*如果您使用邮政服务发送国际货物，售后服务将自动
	*也可以在目的地快递处获得跟踪结果（例如美国的USPS）
     * */
