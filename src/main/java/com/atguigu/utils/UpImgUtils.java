...
//             String toTargetPath =request.getServletContext().getRealPath("/") +"static\\img\\reviewAllImg";
        ...
        *  3、关闭流
        */
        public static String keepCouponWapFile(HttpServletRequest request) throws IOException {
            ...
            */
            ...
            String toTargetPath =request.getServletContext().getRealPath("/") +"static/img/Coupon";//linux状态下
         ...
         *  3、关闭流
         */
        public static String keepCouponPcFile(HttpServletRequest request) throws IOException {
		...
		/*	
          ...
          *  3、关闭流
          */
        public static String keepSlideWapFile(HttpServletRequest request) throws IOException {
              ...
              */
              ...
              String toTargetPath =request.getServletContext().getRealPath("/") +"static/img/Slide";//linux状态下
        ...
        private static String getSlidewapfilename(String slideIdstr) {
          ...
          /*	
      	   * 8.0.2	keepSlidePcFile
           *  1、从request当中获取流信息
           *  2、新建一个临时文件,用输出流指向这个文件
           *  3、关闭流
           */
          public static String keepSlidePcFile(HttpServletRequest request) throws IOException {
           ...
           *  3、关闭流
           */
         public static String keepVideoShowAreaWapFile(HttpServletRequest request) throws IOException {
               ...
               */
               ...
               String newfilenamestr = getVideoShowAreawapfilename(lineEnd);
               filename = newfilenamestr;
               //解决上传文件中文名字乱码
               filename = new String(filename.getBytes("ISO-8859-1"), "UTF-8");
         ...
         private static String getVideoShowAreawapfilename(String slideIdstr) {
            ...
            *  3、关闭流
            */
           public static String keepVideoShowAreaPcFile(HttpServletRequest request) throws IOException {
                ...
                */
                ...
                String newfilenamestr = getVideoShowAreapcfilename(lineEnd);
                //解决上传文件中文名字乱码
                filename = newfilenamestr;
                //解决上传文件中文名字乱码
                filename = new String(filename.getBytes("ISO-8859-1"), "UTF-8");
           ...
           private static String getVideoShowAreapcfilename(String slideIdstr) {
   			Calendar c = Calendar.getInstance();//可以对每个时间域单独修改   对时间进行加减操作等
   			int year = c.get(Calendar.YEAR);  
   			int month = c.get(Calendar.MONTH);   
   			int date = c.get(Calendar.DATE);    
