...
public class UpCouponTitleImgUtils {
       ...
       *  3、关闭流
       */
     public static String keepCouponTitleWapFile(HttpServletRequest request) throws IOException {
           ...
           */
           ...
           String newfilenamestr = getCouponTitlewapfilename(lineEnd);
     ...
     private static String getCouponTitlewapfilename(String couponTitleIdstr) {
		...
		String newfilename = "couponTitleWapId"+ couponTitleIdstr +"time"+date+hour+minute+second+".jpg";
        ...
        *  3、关闭流
        */
       public static String keepCouponTitlePcFile(HttpServletRequest request) throws IOException {
            ...
            */
            ...
            String newfilenamestr = getCouponTitlepcfilename(lineEnd);
            //解决上传文件中文名字乱码
            filename = newfilenamestr;
            //解决上传文件中文名字乱码
            filename = new String(filename.getBytes("ISO-8859-1"), "UTF-8");
       ...
       private static String getCouponTitlepcfilename(String couponTitlepcIdstr) {
		Calendar c = Calendar.getInstance();//可以对每个时间域单独修改   对时间进行加减操作等
		int year = c.get(Calendar.YEAR);  
		int month = c.get(Calendar.MONTH);   
		int date = c.get(Calendar.DATE);    
		...
		int second = c.get(Calendar.SECOND);    
		System.out.println(year + "/" + month + "/" + date + " " +hour + ":" +minute + ":" + second);    
		String newfilename = "couponTitlepcId"+ couponTitlepcIdstr +"time"+date+hour+minute+second+".jpg";
		System.out.println(newfilename);
		return newfilename;
	}
