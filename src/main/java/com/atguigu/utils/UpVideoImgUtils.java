...
public class UpVideoImgUtils {
     ...
     private static String getVideoShowAreawapfilename(String videoShowAreaIdstr) {
       ...
       private static String getVideoShowAreapcfilename(String videoShowAreapcIdstr) {
		Calendar c = Calendar.getInstance();//可以对每个时间域单独修改   对时间进行加减操作等
		int year = c.get(Calendar.YEAR);  
		int month = c.get(Calendar.MONTH);   
		int date = c.get(Calendar.DATE);    
		...
		int second = c.get(Calendar.SECOND);    
		System.out.println(year + "/" + month + "/" + date + " " +hour + ":" +minute + ":" + second);    
		String newfilename = "videoShowAreapcId"+ videoShowAreapcIdstr +"time"+date+hour+minute+second+".jpg";
		System.out.println(newfilename);
		return newfilename;
	}
        ...
        *  3、关闭流
        */
       public static String keepVideoFile(HttpServletRequest request) throws IOException {
            ...
            */
            ...
            String newfilenamestr = getVideofilename(lineEnd);
            //解决上传文件中文名字乱码
            filename = newfilenamestr;
            //解决上传文件中文名字乱码
            filename = new String(filename.getBytes("ISO-8859-1"), "UTF-8");
            ...
            String toTargetPath =request.getServletContext().getRealPath("/") +"static/img/Video";//linux状态下
       ...
       private static String getVideofilename(String videoIdstr) {
		Calendar c = Calendar.getInstance();//可以对每个时间域单独修改   对时间进行加减操作等
		int year = c.get(Calendar.YEAR);  
		int month = c.get(Calendar.MONTH);   
		int date = c.get(Calendar.DATE);    
		...
		int second = c.get(Calendar.SECOND);    
		System.out.println(year + "/" + month + "/" + date + " " +hour + ":" +minute + ":" + second);    
		String newfilename = "videoId"+ videoIdstr +"time"+date+hour+minute+second+".jpg";
		System.out.println(newfilename);
		return newfilename;
	}
